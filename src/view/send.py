...
async def sendmess(text: any, update: Update, context: ContextTypes, reply_markup: any = None):
  await context.bot.send_message(chat_id=update.effective_chat.id, text=str(text), reply_markup=reply_markup)
